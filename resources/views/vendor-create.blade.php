                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group row mb-4">
                                            <div class="col-md-6">
                                                ...
                                                <input type="time" id="opening_time" value="{{old('opening_time')}}" class="form-control @error('opening_time') is-invalid @enderror" name="opening_time" placeholder="Opening Time" maxlength="10" autocomplete="off">
                                                @error('opening_time')
                                                    <span class="invalid-feedback" role="alert">
                                                        <span>{{ $message }}</span>
                                                    </span>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="time" id="closing_time" value="{{old('closing_time')}}" class="form-control @error('closing_time') is-invalid @enderror" name="closing_time" placeholder="Closeing Time" maxlength="10" autocomplete="off">
                                                @error('closing_time')
                                                    <span class="invalid-feedback" role="alert">
                                                        <span>{{ $message }}</span>
                                                    </span>
